...
2. **Identify store context:**
   - Read `interfaces/STORE_MODEL.md`.
...
4. **Re-anchor authority:**
   - Start at `core/DECAPOD.md`.
   - For decision rights, consult `interfaces/DOC_RULES.md` (Decision Rights Matrix).
   - For subsystem existence and truth labels, consult `core/PLUGINS.md`.
5. **If contradiction exists:**
   - Treat it as invalid state.
   - Do not interpret; route to amendment: `specs/AMENDMENTS.md`.
...
3. **Check authority:** Use `core/DECAPOD.md` as your router for all decisions
