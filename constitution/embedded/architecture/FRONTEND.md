...
- `embedded/architecture/CACHING.md` - Caching strategies
- `embedded/architecture/SECURITY.md` - Frontend security
- `embedded/architecture/PERFORMANCE.md` - Performance patterns
