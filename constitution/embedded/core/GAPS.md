...
### 2.1 Interface Gaps (`embedded/interfaces/`)
...
**Routing:**
- Interface contract issues → `embedded/interfaces/INTERFACES.md`
- Store model violations → `embedded/interfaces/STORE_MODEL.md`
- Doc compilation errors → `embedded/interfaces/DOC_RULES.md`
- Claims without proof → `embedded/interfaces/CLAIMS.md`
- Undefined terms → `embedded/interfaces/GLOSSARY.md`

**See:** `embedded/interfaces/INTERFACES.md` for interface contract registry

---

### 2.2 Methodology Gaps (`embedded/methodology/`)
...
**Routing:**
- Intent-driven workflow gaps → `embedded/specs/INTENT.md` (binding methodology)
- Architecture practice gaps → `embedded/methodology/ARCHITECTURE.md`
- Agent behavior gaps → `embedded/methodology/SOUL.md`
- Knowledge management gaps → `embedded/methodology/KNOWLEDGE.md`
- Learning/memory gaps → `embedded/methodology/MEMORY.md`

**See:** `embedded/core/METHODOLOGY.md` for methodology registry

---

### 2.3 Plugin/Subsystem Gaps (`embedded/plugins/`)
...
**Routing:**
- Subsystem status issues → `embedded/core/PLUGINS.md`
- Plugin-specific gaps → respective `embedded/plugins/<NAME>.md`
- Integration gaps → relevant subsystem docs + PLUGINS.md

**See:** `embedded/core/PLUGINS.md` §3.5 for subsystem registry and truth labels

---

### 2.4 Core/Coordination Gaps (`embedded/core/`)
...
**Routing:**
- Router/navigation gaps → `embedded/core/DECAPOD.md`
- Interface index gaps → `embedded/core/INTERFACES.md`
- Methodology index gaps → `embedded/core/METHODOLOGY.md`
- Subsystem registry gaps → `embedded/core/PLUGINS.md`
- User demand gaps → `embedded/core/DEMANDS.md`
- Deprecation gaps → `embedded/core/DEPRECATION.md`
- Gap analysis methodology → `embedded/core/GAPS.md` (this file)

---

### 2.5 Specification Gaps (`embedded/specs/`)
...
**Routing:**
- Intent/methodology contract gaps → `embedded/specs/INTENT.md`
- System definition gaps → `embedded/specs/SYSTEM.md`
- Security gaps → `embedded/specs/SECURITY.md`
- Git workflow gaps → `embedded/specs/GIT.md`
- Change control gaps → `embedded/specs/AMENDMENTS.md`
...
**Decision tree:**
1. Is it a missing/incomplete binding contract? → `embedded/interfaces/`
2. Is it unclear how to do something? → `embedded/methodology/`
3. Is it missing functionality? → `embedded/plugins/` or `embedded/core/PLUGINS.md`
4. Is it navigation/routing? → `embedded/core/DECAPOD.md`
5. Is it system-level contract? → `embedded/specs/`
...
- Update `embedded/core/INTERFACES.md` if interface gaps
- Update `embedded/core/METHODOLOGY.md` if methodology gaps
- Update `embedded/core/PLUGINS.md` if plugin gaps
...
**See:** `embedded/plugins/TODO.md` for work tracking
...
**See:** `embedded/interfaces/CONTROL_PLANE.md` §6 for validate doctrine
...
**See:** `embedded/methodology/KNOWLEDGE.md` for knowledge management
...
**See:** `embedded/methodology/MEMORY.md` for learning patterns
...
|-------|----------|------------|
| Interfaces | Missing contracts, schemas, invariants | `embedded/core/INTERFACES.md` |
| Methodology | Unclear practices, missing guidance | `embedded/core/METHODOLOGY.md` |
| Plugins | Missing functionality, incomplete impl | `embedded/core/PLUGINS.md` |
| Core | Routing, navigation, coordination | `embedded/core/DECAPOD.md` |
| Specs | System contracts, security, process | `embedded/specs/` |
...
4. Consult `embedded/plugins/EMERGENCY_PROTOCOL.md`
...
- Reference `embedded/interfaces/DOC_RULES.md` §8
...
- `embedded/plugins/EMERGENCY_PROTOCOL.md` - Critical issues
- `embedded/interfaces/CONTROL_PLANE.md` - Validation doctrine
- `embedded/interfaces/CLAIMS.md` - Promises ledger
- `embedded/methodology/KNOWLEDGE.md` - Knowledge management
- `embedded/methodology/MEMORY.md` - Learning patterns
