...
1. **Intent-First Principle:** Treat `specs/INTENT.md` as the top contract. If reality disagrees, either update intent explicitly or perform drift recovery. No silent divergence.
