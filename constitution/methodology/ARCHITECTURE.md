...
**Reference:** See `architecture/DATA.md` for data modeling, storage, and governance patterns.

---

### 2.2 Caching Architecture (`architecture/CACHING.md`)
...
**Reference:** See `architecture/CACHING.md` for cache strategies and patterns.

---

### 2.3 Memory Architecture (`architecture/MEMORY.md`)
...
**Reference:** See `architecture/MEMORY.md` for memory management and optimization.

---

### 2.4 Web Architecture (`architecture/WEB.md`)
...
**Reference:** See `architecture/WEB.md` for web patterns and API design.

---

### 2.5 Cloud Architecture (`architecture/CLOUD.md`)
...
**Reference:** See `architecture/CLOUD.md` for cloud patterns and infrastructure.

---

### 2.6 Frontend Architecture (`architecture/FRONTEND.md`)
...
**Reference:** See `architecture/FRONTEND.md` for frontend patterns and performance.

---

### 2.7 Algorithms & Data Structures (`architecture/ALGORITHMS.md`)
...
**Reference:** See `architecture/ALGORITHMS.md` for algorithm selection and optimization.

---

### 2.8 Security Architecture (`architecture/SECURITY.md`)
...
**Reference:** See `architecture/SECURITY.md` and `specs/SECURITY.md` for security patterns.

---

### 2.9 Observability Architecture (`architecture/OBSERVABILITY.md`)
...
**Reference:** See `architecture/OBSERVABILITY.md` for observability patterns.

---

### 2.10 Concurrency & Parallelism (`architecture/CONCURRENCY.md`)
...
**Reference:** See `architecture/CONCURRENCY.md` for concurrency patterns.
...
|--------|------|---------------|
| Data | `architecture/DATA.md` | Persistence, schema, governance |
| Caching | `architecture/CACHING.md` | Performance, invalidation |
| Memory | `architecture/MEMORY.md` | Resource optimization |
| Web | `architecture/WEB.md` | APIs, protocols, statelessness |
| Cloud | `architecture/CLOUD.md` | Infrastructure, scaling, cost |
| Frontend | `architecture/FRONTEND.md` | UX, performance, accessibility |
| Algorithms | `architecture/ALGORITHMS.md` | Efficiency, complexity |
| Security | `architecture/SECURITY.md` | Threats, defense, compliance |
| Observability | `architecture/OBSERVABILITY.md` | Monitoring, debugging, tracing |
| Concurrency | `architecture/CONCURRENCY.md` | Parallelism, coordination |
...
- `specs/INTENT.md` - System intent and binding contracts
...
- `architecture/ALGORITHMS.md` - Algorithms & data structures
...
- `methodology/TESTS.md` - Testing methodology (extracted)
