...
| claim.architecture.artifact_required_for_governed_execution | Governed execution architecture directives MUST be defined in constitution interfaces, not mutable runtime `.decapod/*` artifacts. | `interfaces/ARCHITECTURE_FOUNDATIONS.md` | not_enforced | planned: architecture directive gate | Keeps architecture policy repo-native and constitutional. |
