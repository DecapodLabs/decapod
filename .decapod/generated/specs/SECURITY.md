...
|----------|------|--------------|
| Validation report | `.decapod/generated/artifacts/provenance/validation_report.json` | `validate` (ignored current-run output) |
| Proof manifest | `.decapod/generated/artifacts/provenance/proof_manifest.json` | `proof run` (ignored current-run output) |
| Artifact manifest | `.decapod/generated/artifacts/provenance/artifact_manifest.json` | `workspace publish` (ignored current-run output) |
...
- Repository signal fingerprint: `f872f6597afb36c661004037f46bde61a87026f7bb3c46ac3c983871f7b770d8`
- Significant implementation surfaces: `.github/` (8 files), `Cargo.lock/` (1 files), `Cargo.toml/` (1 files), `README.md/` (1 files), `crates/` (1 files), `docs/` (1 files), `src/` (92 files), `tests/` (4 files)
