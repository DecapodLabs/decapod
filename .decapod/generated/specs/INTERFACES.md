...
| `decapod govern plan phase add` | Declare ordered phase contracts | `--plan-id`, `--phase-id`, `--entry-gate`, `--exit-gate` | PhaseContract[] |
| `decapod govern plan phase enter` | Enter next phase (evaluate entry gates) | `--plan-id`, `--phase-id` | PhaseState |
| `decapod govern plan phase complete` | Complete active phase (evaluate exit gates) | `--plan-id`, `--phase-id` | PhaseState |
