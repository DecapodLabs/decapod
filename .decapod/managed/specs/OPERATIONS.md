...
- Correlate attestations (`.decapod/managed/assurance_attestations.jsonl`)
- Review validation report (`.decapod/managed/artifacts/provenance/validation_report.json`)## Rollout Strategy
...
|----------|------|--------------|
| Validation report | `.decapod/managed/artifacts/provenance/validation_report.json` | `validate` |
| Proof manifest | `.decapod/managed/artifacts/provenance/proof_manifest.json` | `proof run` |
| Artifact manifest | `.decapod/managed/artifacts/provenance/artifact_manifest.json` | `workspace publish` |
