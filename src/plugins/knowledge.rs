...
pub fn add_knowledge(
    ...
    if !matches!(args.status, "active" | "superseded" | "deprecated" | "stale") {
        return Err(error::DecapodError::ValidationError(format!(
    ...
    .map_err(|e| match e {
        error::DecapodError::RusqliteError(rusqlite::Error::ExecuteReturnedResults) => {
...
pub fn decay_knowledge(
    ...
    let as_of = as_of.unwrap_or(&now_iso());
