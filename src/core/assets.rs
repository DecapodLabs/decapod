...
pub const CONSTITUTION_CORE_CONTROL_PLANE: &str =
    include_str!("../../constitution/embedded/core/CONTROL_PLANE.md");
pub const CONSTITUTION_CORE_DECAPOD: &str =
    include_str!("../../constitution/embedded/core/DECAPOD.md");
pub const CONSTITUTION_CORE_PLUGINS: &str =
    include_str!("../../constitution/embedded/core/PLUGINS.md");
pub const CONSTITUTION_CORE_CLAIMS: &str =
    include_str!("../../constitution/embedded/core/CLAIMS.md");
pub const CONSTITUTION_CORE_DEMANDS: &str =
    include_str!("../../constitution/embedded/core/DEMANDS.md");
pub const CONSTITUTION_CORE_DEPRECATION: &str =
    include_str!("../../constitution/embedded/core/DEPRECATION.md");
pub const CONSTITUTION_CORE_DOC_RULES: &str =
    include_str!("../../constitution/embedded/core/DOC_RULES.md");
pub const CONSTITUTION_CORE_GLOSSARY: &str =
    include_str!("../../constitution/embedded/core/GLOSSARY.md");
pub const CONSTITUTION_CORE_KNOWLEDGE: &str =
    include_str!("../../constitution/embedded/core/KNOWLEDGE.md");
pub const CONSTITUTION_CORE_MEMORY: &str =
    include_str!("../../constitution/embedded/core/MEMORY.md");
pub const CONSTITUTION_CORE_SOUL: &str = include_str!("../../constitution/embedded/core/SOUL.md");
pub const CONSTITUTION_CORE_STORE_MODEL: &str =
    include_str!("../../constitution/embedded/core/STORE_MODEL.md");

// Constitution Specs Docs (embedded from embedded directory)
pub const CONSTITUTION_SPECS_AMENDMENTS: &str =
    include_str!("../../constitution/embedded/specs/AMENDMENTS.md");
pub const CONSTITUTION_SPECS_ARCHITECTURE: &str =
    include_str!("../../constitution/embedded/specs/ARCHITECTURE.md");
pub const CONSTITUTION_SPECS_INTENT: &str =
    include_str!("../../constitution/embedded/specs/INTENT.md");
pub const CONSTITUTION_SPECS_SYSTEM: &str =
    include_str!("../../constitution/embedded/specs/SYSTEM.md");

// Constitution Plugins Docs (embedded from embedded directory)
pub const CONSTITUTION_PLUGINS_DB_BROKER: &str =
    include_str!("../../constitution/embedded/plugins/DB_BROKER.md");
pub const CONSTITUTION_PLUGINS_MANIFEST: &str =
    include_str!("../../constitution/embedded/plugins/MANIFEST.md");
pub const CONSTITUTION_PLUGINS_TODO: &str =
    include_str!("../../constitution/embedded/plugins/TODO.md");
pub const CONSTITUTION_PLUGINS_TODO_USER: &str =
    include_str!("../../constitution/embedded/plugins/TODO_USER.md");
pub const CONSTITUTION_PLUGINS_CRON: &str =
    include_str!("../../constitution/embedded/plugins/CRON.md");
pub const CONSTITUTION_PLUGINS_REFLEX: &str =
    include_str!("../../constitution/embedded/plugins/REFLEX.md");
pub const CONSTITUTION_PLUGINS_HEALTH: &str =
    include_str!("../../constitution/embedded/plugins/HEALTH.md");
pub const CONSTITUTION_PLUGINS_POLICY: &str =
    include_str!("../../constitution/embedded/plugins/POLICY.md");
pub const CONSTITUTION_PLUGINS_WATCHER: &str =
    include_str!("../../constitution/embedded/plugins/WATCHER.md");
pub const CONSTITUTION_PLUGINS_KNOWLEDGE: &str =
    include_str!("../../constitution/embedded/plugins/KNOWLEDGE.md");
pub const CONSTITUTION_PLUGINS_ARCHIVE: &str =
    include_str!("../../constitution/embedded/plugins/ARCHIVE.md");
pub const CONSTITUTION_PLUGINS_FEEDBACK: &str =
    include_str!("../../constitution/embedded/plugins/FEEDBACK.md");
pub const CONSTITUTION_PLUGINS_TRUST: &str =
    include_str!("../../constitution/embedded/plugins/TRUST.md");
pub const CONSTITUTION_PLUGINS_CONTEXT: &str =
    include_str!("../../constitution/embedded/plugins/CONTEXT.md");
pub const CONSTITUTION_PLUGINS_HEARTBEAT: &str =
    include_str!("../../constitution/embedded/plugins/HEARTBEAT.md");
...
pub fn list_docs() -> Vec<String> {
    vec![
        "embedded/core/CONTROL_PLANE.md".to_string(),
        "embedded/core/DECAPOD.md".to_string(),
        "embedded/core/PLUGINS.md".to_string(),
        "embedded/core/CLAIMS.md".to_string(),
        "embedded/core/DEMANDS.md".to_string(),
        "embedded/core/DEPRECATION.md".to_string(),
        "embedded/core/DOC_RULES.md".to_string(),
        "embedded/core/GLOSSARY.md".to_string(),
        "embedded/core/KNOWLEDGE.md".to_string(),
        "embedded/core/MEMORY.md".to_string(),
        "embedded/core/SOUL.md".to_string(),
        "embedded/core/STORE_MODEL.md".to_string(),
        "embedded/specs/AMENDMENTS.md".to_string(),
        "embedded/specs/ARCHITECTURE.md".to_string(),
        "embedded/specs/INTENT.md".to_string(),
        "embedded/specs/SYSTEM.md".to_string(),
        "embedded/plugins/DB_BROKER.md".to_string(),
        "embedded/plugins/MANIFEST.md".to_string(),
        "embedded/plugins/TODO.md".to_string(),
        "embedded/plugins/TODO_USER.md".to_string(),
        "embedded/plugins/CRON.md".to_string(),
        "embedded/plugins/REFLEX.md".to_string(),
        "embedded/plugins/HEALTH.md".to_string(),
        "embedded/plugins/POLICY.md".to_string(),
        "embedded/plugins/WATCHER.md".to_string(),
        "embedded/plugins/KNOWLEDGE.md".to_string(),
        "embedded/plugins/ARCHIVE.md".to_string(),
        "embedded/plugins/FEEDBACK.md".to_string(),
        "embedded/plugins/TRUST.md".to_string(),
        "embedded/plugins/CONTEXT.md".to_string(),
        "embedded/plugins/HEARTBEAT.md".to_string(),
    ]
}
