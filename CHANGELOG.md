...
## [0.104.3](https://github.com/DecapodLabs/decapod/compare/v0.104.2...v0.104.3) - 2026-09-20
...
- evaluate Jev trajectory observation
- make docs sync checkout adapter-compatible
- Add optional Jev decision provider seam
- Record governed validation for decision provider
- Record decision-provider governance boundary
- Add optional Jev decision provider seam

## [0.102.2](https://github.com/DecapodLabs/decapod/compare/v0.102.1...v0.102.2) - 2026-09-19

### Other

- refresh Decapod 0.102.1 release pins
- Migrate CI to native Buildkite pipeline-as-code
...
- Revert durable trajectory archives
...
- report current workspace during prune
- report current workspace during prune

### Other

- align governance projections with master
...
- record PR 1274 validation blocker
- Merge origin/master into PR #1274 branch

## [0.99.5](https://github.com/DecapodLabs/decapod/compare/v0.99.4...v0.99.5) - 2026-08-27

### Fixed

- bound event migration and validation replay
...
- sync release-bound entrypoints and living specs
...
- include claims governance artifact
- speed project validation installs

## [0.96.12](https://github.com/DecapodLabs/decapod/compare/v0.96.11...v0.96.12) - 2026-08-06

### Other

- Revise README structure and content

## [0.96.11](https://github.com/DecapodLabs/decapod/compare/v0.96.10...v0.96.11) - 2026-08-06

### Fixed

- keep release merges outside validation

## [0.96.10](https://github.com/DecapodLabs/decapod/compare/v0.96.9...v0.96.10) - 2026-08-06

### Other

- sync release-bound entrypoints and living specs

## [0.96.9](https://github.com/DecapodLabs/decapod/compare/v0.96.8...v0.96.9) - 2026-08-06

### Fixed

- keep workspace publication artifacts current

## [0.96.8](https://github.com/DecapodLabs/decapod/compare/v0.96.7...v0.96.8) - 2026-08-06
...
- *(nix)* prove Darwin packaging and guard Rust overlay drift

### Other

- *(nix)* move packaging notes off README; refresh validation receipt
...
- *(release)* heal stale release-bound entrypoint pins after version bumps and stop CI `init --force` from inventing living-spec drift; sync release-labeled PRs automatically
...
- *(nix)* expose flake.nix on master with packages.default ([#1157](https://github.com/DecapodLabs/decapod/pull/1157)) ([#1169](https://github.com/DecapodLabs/decapod/pull/1169))
...
- Houseboat wave 4 lease-aware handoff + entrypoint/Dockerfile integrity (#852 #1154)
- *(validate)* enforce entrypoint and Dockerfile release pins ([#1154](https://github.com/DecapodLabs/decapod/pull/1154))
- *(houseboat)* make todo handoff lease-aware
- *(houseboat)* add pure handoff lease-transfer helpers

### Other

- recapture verification baselines with source-built validate
- recapture verification baselines for stuck done todos
- bind houseboat wave 4 governance plan and receipts
- regenerate v0.94.1 entrypoints, Dockerfile, and specs
...
- preserve governance authority and canonical evidence
...
- consolidate local event streams into decapod.db
- consolidate local state into one SQLite datastore

### Fixed

- migrate legacy event tables by shared columns

### Other

- refresh governed artifacts for datastore PR

## [0.89.1](https://github.com/DecapodLabs/decapod/compare/v0.89.0...v0.89.1) - 2026-07-31

### Added

- make Propodus init the canonical cloud setup

### Other

- finalize Propodus governance evidence
- record Propodus lifecycle claim
- record Propodus lifecycle validation
...
- make backend cloud session acquisition seamless

## [0.86.2](https://github.com/DecapodLabs/decapod/compare/v0.86.1...v0.86.2) - 2026-07-28

### Other

- Refactor Mermaid diagram for clarity and structure
...
- scope validation temp artifacts to todo tasks ([#999](https://github.com/DecapodLabs/decapod/pull/999))

## [0.80.0](https://github.com/DecapodLabs/decapod/compare/v0.79.1...v0.80.0) - 2026-07-23

### Fixed

- make validation parallel and agent-readable

### Other

- bind validation proof to final commit
- record validation proof for 986 987
...
- consolidate governed runtime receipts
...
- initialize git by default during init

## [0.73.2](https://github.com/DecapodLabs/decapod/compare/v0.73.1...v0.73.2) - 2026-07-22

### Fixed

- make houseboat workspace cleanup recoverable

## [0.73.1](https://github.com/DecapodLabs/decapod/compare/v0.73.0...v0.73.1) - 2026-07-22

### Added

- add run trajectory proof artifacts
...
- refresh governed validation artifacts
- clarify idiomatic error handling and CLI failures

## [0.72.16](https://github.com/DecapodLabs/decapod/compare/v0.72.15...v0.72.16) - 2026-07-21

### Fixed

- fall back when machine session storage is unavailable

### Other

- allow container boundary doctrine
...
- Uplift plugin subsystem constitution doctrine

## [0.72.7](https://github.com/DecapodLabs/decapod/compare/v0.72.6...v0.72.7) - 2026-07-21

### Other

- Uplift metadata constitution doctrine

## [0.72.6](https://github.com/DecapodLabs/decapod/compare/v0.72.5...v0.72.6) - 2026-07-21

### Fixed

- make decapod init robust and resolve test suite failures

## [0.72.5](https://github.com/DecapodLabs/decapod/compare/v0.72.4...v0.72.5) - 2026-07-21

### Other

- Fix specs refresh test fixture
- Uplift data constitution doctrine

## [0.72.4](https://github.com/DecapodLabs/decapod/compare/v0.72.3...v0.72.4) - 2026-07-20

### Other

- Keep all interface decision labels schema-safe
- Keep constitution decision labels within schema bounds
- Uplift interface doctrine and release version tests
...
- align living specs with v0.72.0 transport contracts

## [0.72.0](https://github.com/DecapodLabs/decapod/compare/v0.71.5...v0.72.0) - 2026-07-20

### Added

- complete identity provenance and HTTP transport issues

## [0.71.5](https://github.com/DecapodLabs/decapod/compare/v0.71.4...v0.71.5) - 2026-07-20

### Fixed

- enforce configured identity trust roots ([#876](https://github.com/DecapodLabs/decapod/pull/876))
...
- enforce claim-specific identity verification
...
- enforce per-file release entrypoint fingerprints
...
- add governed activation conformance fixture ([#908](https://github.com/DecapodLabs/decapod/pull/908))

## [0.69.0](https://github.com/DecapodLabs/decapod/compare/v0.68.0...v0.69.0) - 2026-07-16

### Added

- add portable completion evidence custody ([#906](https://github.com/DecapodLabs/decapod/pull/906))

## [0.68.0](https://github.com/DecapodLabs/decapod/compare/v0.67.0...v0.68.0) - 2026-07-16

### Added

- add reproducible completion evidence verification ([#904](https://github.com/DecapodLabs/decapod/pull/904))
...
- detect and honor repository base branch ([#898](https://github.com/DecapodLabs/decapod/pull/898))

## [0.66.8](https://github.com/DecapodLabs/decapod/compare/v0.66.7...v0.66.8) - 2026-07-15

### Fixed

- explain stable validation proof failures ([#896](https://github.com/DecapodLabs/decapod/pull/896))
...
- stabilize docs, workspace, and container contracts ([#885](https://github.com/DecapodLabs/decapod/pull/885))

## [0.66.3](https://github.com/DecapodLabs/decapod/compare/v0.66.2...v0.66.3) - 2026-07-13

### Other

- (docs) add citation to paper link ([#883](https://github.com/DecapodLabs/decapod/pull/883))

## [0.66.2](https://github.com/DecapodLabs/decapod/compare/v0.66.1...v0.66.2) - 2026-07-13

### Other

- add research paper link to README ([#881](https://github.com/DecapodLabs/decapod/pull/881))
...
- add projection-consistency validation for Decapod-governed surfaces ([#847](https://github.com/DecapodLabs/decapod/pull/847))

## [0.63.7](https://github.com/DecapodLabs/decapod/compare/v0.63.6...v0.63.7) - 2026-07-11

### Fixed

- use decapod docs ingest for agent orientation corpus ([#843](https://github.com/DecapodLabs/decapod/pull/843))

## [0.63.6](https://github.com/DecapodLabs/decapod/compare/v0.63.5...v0.63.6) - 2026-07-11

### Fixed

- *(specs)* re-evaluate living specs from codebase ([#841](https://github.com/DecapodLabs/decapod/pull/841))

## [0.63.5](https://github.com/DecapodLabs/decapod/compare/v0.63.4...v0.63.5) - 2026-07-11

### Added

- *(governance)* enforce ordered phase gates ([#839](https://github.com/DecapodLabs/decapod/pull/839))

## [0.63.4](https://github.com/DecapodLabs/decapod/compare/v0.63.3...v0.63.4) - 2026-07-09

### Other

- Fix release workflow reruns for existing releases ([#834](https://github.com/DecapodLabs/decapod/pull/834))
...
- Standardize Rust Developer Workflow Tooling ([#827](https://github.com/DecapodLabs/decapod/pull/827))
...
- Uplift architecture constitution doctrine model ([#815](https://github.com/DecapodLabs/decapod/pull/815))

## [0.62.5](https://github.com/DecapodLabs/decapod/compare/v0.62.4...v0.62.5) - 2026-07-07

### Other

- Uplift core constitution routing doctrine ([#811](https://github.com/DecapodLabs/decapod/pull/811))

## [0.62.4](https://github.com/DecapodLabs/decapod/compare/v0.62.3...v0.62.4) - 2026-07-07

### Other

- Expand constitution scaffolding doctrine ([#799](https://github.com/DecapodLabs/decapod/pull/799))

## [0.62.3](https://github.com/DecapodLabs/decapod/compare/v0.62.2...v0.62.3) - 2026-07-07

### Added

- publish decapod workspace image ([#797](https://github.com/DecapodLabs/decapod/pull/797))

## [0.62.2](https://github.com/DecapodLabs/decapod/compare/v0.62.1...v0.62.2) - 2026-07-07

### Other

- Enforce generated specs and PR workunit trajectories ([#795](https://github.com/DecapodLabs/decapod/pull/795))

## [0.62.1](https://github.com/DecapodLabs/decapod/compare/v0.62.0...v0.62.1) - 2026-07-07

### Other

- bump all deps to latest, relax version pins, add rust-toolchain.toml ([#791](https://github.com/DecapodLabs/decapod/pull/791))

## [0.62.0](https://github.com/DecapodLabs/decapod/compare/v0.61.1...v0.62.0) - 2026-07-07

### Other

- consolidate similar active todos ([#790](https://github.com/DecapodLabs/decapod/pull/790))
...
- Add validation epoch provenance ([#786](https://github.com/DecapodLabs/decapod/pull/786))
...
## [0.60.15](https://github.com/DecapodLabs/decapod/compare/v0.60.14...v0.60.15) - 2026-06-30

### Other

- Fix workspace container Decapod image
